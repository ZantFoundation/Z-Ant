...
const NodeProto = @import("nodeProto.zig").NodeProto;
const TensorProto = @import("tensorProto.zig").TensorProto;
const ValueInfoProto = @import("valueInfoProto.zig").ValueInfoProto;
...
const OperatorSetIdProto = @import("operatorSetIdProto.zig").OperatorSetIdProto;
