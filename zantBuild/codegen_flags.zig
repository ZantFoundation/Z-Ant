...
pub const Codegen_flags = struct {
    ...
    pub fn init(b: *std.Build) !Codegen_flags {
        ...
        return Codegen_flags{
            ...
            .branch_and_bound = b.option(usize, "branch_and_bound", "Use branch and bound for static memory planning if node count is <= this value") orelse 25,
